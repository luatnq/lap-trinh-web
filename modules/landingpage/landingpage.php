...
<head>
    ...
    <link rel="stylesheet" href="../../assets/landingpage_style.css">
            ...
            <nav class="navbar navbar-expand-lg bg-dark navbar-dark fixed-top">
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <a class="btn btn-secondary rounded-pill fw-bold" href="../login/login.php">Đăng nhập</a>
                    </div>
                </div>
            </nav>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-6 mb-4">
                    <div>
                        <a>
                            <img class="img-fluid" src="./img/linhkien5.jpg" alt="..." />
                        </a>
                        <div>
